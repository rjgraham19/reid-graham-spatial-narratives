...
/* The breathing room above and below the description (subtitle →
   description, description → credits): 48 / 64 / 144px. */
const introDescriptionGap = "mt-12 md:mt-16 lg:mt-36";
    ...
    >
      ...
      {introTrial && !introSplit && (
        <>
          ...
          <div className="order-3 px-6 md:px-12 lg:px-16 pt-12 md:pt-16 lg:pt-36 pb-14 md:pb-20">
