  ...
  return (
    ...
    >
        ...
        <section className="px-6 md:px-12 lg:px-16 pt-2 md:pt-4 pb-4 md:pb-6">
          ...
          <div className="md:grid md:grid-cols-2 md:gap-8 lg:gap-12 md:items-start">
            ...
            <div className="mt-6 md:mt-0">
              <RevealBlock>
                <p className="font-display font-light text-base md:text-lg leading-snug tracking-tight text-balance">
        ...
        <div ref={recordScrubWrapperRef} className="relative w-full h-[400vh] lolla-bg" data-record-player-section>
          ...
          <div className="sticky top-0 h-[100svh] w-full overflow-hidden">
            ...
            <p
              ...
              style={{ opacity: 0 }}
              className="record-player-caption hidden md:block absolute left-[60%] top-[46%] max-w-[30rem] -translate-y-1/2 font-display font-light text-base lg:text-lg leading-snug tracking-tight text-white"
            >
      ...
      {isRagsToRiches && (
        <section className="px-6 md:px-20 lg:px-28 py-6 md:py-8">
          <RevealBlock>
            <p className="font-display font-light text-base md:text-lg leading-snug tracking-tight text-balance text-center">
          ...
          {project.extendedDescription && (
            <section className="px-6 md:px-12 lg:px-16 pt-8 md:pt-10">
              <RevealBlock>
                <p
                  data-design-kind="text"
                  className="font-display font-light text-base md:text-lg leading-snug tracking-tight text-balance max-w-3xl"
                >
                  {project.extendedDescription}
                </p>
              </RevealBlock>
        ...
        {isAnneFrank ? (
          ...
          {project.extendedDescription && (
            <RevealBlock>
              <p
                data-design-kind="text"
                className="font-display font-light text-base md:text-lg leading-snug tracking-tight text-balance max-w-3xl mb-8 md:mb-10"
              >
                {project.extendedDescription}
              </p>
            </RevealBlock>
